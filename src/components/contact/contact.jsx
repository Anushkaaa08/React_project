...
const ContactUs = () => {
  return (
    <section class=" dark:bg-gray-900 pt-20" style={{backgroundColor:"#fbecea"}}>
  ...
  marginwidth="0"
  scrolling="no"
  src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=Marathahalli%20Bangalore&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed">
</iframe>
